...
impl Logger {
    fn init(boxed_logger: Box<Logger>, max_level_filter: Option<LevelFilter>) -> Result<(), SetLoggerError> {
    ...
    pub fn activate(path: Option<String>, max_level_filter: Option<LevelFilter>) -> Result<(), SetLoggerError> {
...
mod tests {
    ...
    #[test]
    fn test_simple_logger_with_stdout() {
        Logger::activate(None,Some(LevelFilter::Error)).unwrap();
